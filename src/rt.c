...
void			get_obj_lst(t_env *e, t_obj obj, int *i)
{
	...
	if (obj.type == 7)
	{
		...
		e->l_obj[*i].type = 6;
		e->l_obj[*i].dir = mat[0];
		e->l_obj[*i].point = mat[1];
		e->l_obj[*i].pos = vadd(obj.pos, vmult_dbl(mat[0], obj.radius / 2));
		(*i)++;
		e->l_obj[*i] = obj;
		e->l_obj[*i].id = *i + 1;
		e->l_obj[*i].type = 6;
		...
		e->l_obj[*i].type = 6;
		e->l_obj[*i].dir = mat[1];
		e->l_obj[*i].point = mat[2];
		e->l_obj[*i].pos = vadd(obj.pos, vmult_dbl(mat[1], obj.radius / 2));
		(*i)++;
		e->l_obj[*i] = obj;
		e->l_obj[*i].id = *i + 1;
		e->l_obj[*i].type = 6;
		...
		e->l_obj[*i].type = 6;
		e->l_obj[*i].dir = mat[2];
		e->l_obj[*i].point = mat[0];
		e->l_obj[*i].pos = vadd(obj.pos, vmult_dbl(mat[2], obj.radius / 2));
		(*i)++;
		e->l_obj[*i] = obj;
		e->l_obj[*i].id = *i + 1;
		e->l_obj[*i].type = 6;
