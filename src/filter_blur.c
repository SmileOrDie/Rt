...
/*   Updated: 2017/06/09 11:27:53 by phmoulin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    filter_blur(t_env *e, int *rgb, int x, int y)/////////////////////a passe en matrice 5/5 https://en.wikipedia.org/wiki/Kernel_(image_processing)
{
    int     *tab = NULL;
